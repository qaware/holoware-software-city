...
namespace SoftwareCities.figures
{
    ...
    public class Material
    {
        ...
        // Neon
        public static readonly Material PurpleNeon = new Material("neon-tower");
        public static readonly Material PurpleNeonNoEmission = new Material("M_Tileable_Cube_Purple_No_Emission");
        public static readonly Material NeonFloor = new Material("neon-floor");
        public static readonly Material RedNeon = new Material("M_Tileable_Cube_Red");
        public static readonly Material NeonTube = new Material("neon-tube");
        public static readonly Material NeonCycle = new Material("neon-cycle");
        ...
        // Materials different for day / night view, pointers to true materials set in SetDay(), SetNight()

        public static readonly Material tower = new Material("");
        public static readonly Material cyclicTower = new Material("");
        public static readonly Material cyclicPackage = new Material("");
        public static readonly Material topPackage = new Material("");
        public static readonly Material defaultPackage = new Material("");
        public static readonly Material usecaseTube = new Material("");
        public static readonly Material cyclicTube = new Material("");
        public static readonly Material viewDescription = new Material("");
        ...
        {
            tower.idName = BlueMetal2.idName;
            cyclicTower.idName = RedMetal.idName;
            cyclicPackage.idName = RedMetal.idName;
            topPackage.idName = WhiteMetal.idName;
            defaultPackage.idName = OrangeMetal.idName;
            usecaseTube.idName = BlueGlass.idName;
            cyclicTube.idName = RedGlass.idName;
            viewDescription.idName = OrangeGlass.idName;

        }

        public static void SetNight()
        {
            tower.idName = PurpleNeon.idName;
            cyclicTower.idName = PurpleNeon.idName;
            cyclicPackage.idName = NeonFloor.idName;
            topPackage.idName = NeonFloor.idName;
            defaultPackage.idName = NeonFloor.idName;
            usecaseTube.idName = NeonTube.idName;
            cyclicTube.idName = NeonCycle.idName;
            viewDescription.idName = NeonFloor.idName;
        }
